...
public class Shopnek_Earrings {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement dropdownElement = driver.findElement(By.xpath("//p[@class='text-sm' and text()='Earrings']"));
        Actions act = new Actions(driver);
        act.moveToElement(dropdownElement).perform();
        Thread.sleep(2000); 

       
        List<WebElement> options = driver.findElements(By.xpath("//p[@class='text-sm' and text()='Earrings']"));
        ...
        expectedOptions.add("All Earrings");
