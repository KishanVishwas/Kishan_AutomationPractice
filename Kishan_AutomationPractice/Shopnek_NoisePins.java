...
public class Shopnek_NoisePins {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement dropdownElement = driver.findElement(By.xpath("//p[@class='text-sm' and text()='Nose pins']"));
        Actions act = new Actions(driver);
        act.moveToElement(dropdownElement).perform();
        Thread.sleep(2000); 

       
        List<WebElement> options = driver.findElements(By.xpath("//p[@class='text-sm' and text()='Nose pins']"));
        ...
        expectedOptions.add("All Nose Pins");
